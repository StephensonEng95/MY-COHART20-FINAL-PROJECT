...
<%
List<Product> prod =(List<Product>)request.getAttribute("dbProductData");
%> 
<h3 style="margin-left:500px;margin-right:500px">Number of products available<br> <%=prod.size()%></h3>
